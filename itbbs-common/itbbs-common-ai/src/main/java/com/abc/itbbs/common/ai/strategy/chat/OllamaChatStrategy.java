...
@Service
public class OllamaChatStrategy extends BaseChatStrategy {
    ...
    protected String getModel() {
        String model = env.getProperty("ai.ollama.model");
        return StringUtils.isEmpty(model) ? AiConstants.OLLAMA_MODEL : model;
    }

    @Override
    protected String getApiKey() {
        return env.getProperty("ai.ollama.api-key");
    }
}
